 ...
 * @author geova
 */
public class excluir_turma extends javax.swing.JFrame {

    /**
     * Creates new form TelaAdmin
     */
    public excluir_turma() {
        initComponents();
        AtualizaCombo();
    }
    ...
    private void btn_cad_discActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cad_discActionPerformed
        ...
        String turma = jCB_disc.getSelectedItem().toString();
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(excluir_turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
