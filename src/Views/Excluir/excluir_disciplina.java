 ...
 * @author geova
 */
public class excluir_disciplina extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtf_id_disc.setBounds(290, 300, 70, 40);
    ...
    private void btn_cad_discActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cad_discActionPerformed
        String codigo = jtf_id_disc.getText();
        ...
        if (nome.equals("")) {
            ...
            int b = JOptionPane.showConfirmDialog(null, "Deseja realmente excluir"+
                    "\n a disciplina ("+ nome +")?", "Banco de questões",
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(excluir_disciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
