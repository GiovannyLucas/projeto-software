 ...
 * @author geova
 */
public class excluir_assunto extends javax.swing.JFrame {

    /**
     * Creates new form TelaAdmin
     */
    public excluir_assunto() {
        initComponents();
        AtualizaCombo();
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setBounds(260, 290, 310, 30);
...
dispose();
    ...
    private void btn_pesq_disci1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pesq_disci1ActionPerformed
        ...
        String nome = jCB_prova.getSelectedItem().toString();
    ...
    private void jCB_provaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCB_provaActionPerformed
        ...
        lista = sql.ConsultaCodigoAssunto(id_prova);

        for (Assunto b : lista) {
            int a = (int) b.getId();
            jtf_id_prof.setText("" + b.getId());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(excluir_assunto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
