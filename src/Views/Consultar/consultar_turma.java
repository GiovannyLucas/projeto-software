 ...
 * @author geova
 */
public class consultar_turma extends javax.swing.JFrame {
    ...
    private void AtualizaTable() {
        ...
        TurmaDAO bd = new TurmaDAO((com.mysql.jdbc.Connection) con);
        List<Turma> lista = new ArrayList<>();
        lista = bd.Listar_Turma();
        ...
        for (Turma tab : lista) {
            ...
            jTable.setValueAt(tab.getSerie(), i, 1);
            i++;
        }
    ...
    private void initComponents() {
        ...
        nome_turma = new javax.swing.JTextField();
        ...
        jLabel11.setText("Pesquisar por código da turma:");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(90, 170, 250, 30);
        jPanel1.add(id_turma);
        id_turma.setBounds(90, 210, 130, 40);
        ...
        jPanel1.add(nome_turma);
        nome_turma.setBounds(350, 210, 130, 40);
        ...
        jLabel12.setText("Pesquisar por nome da turma:");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(350, 170, 220, 30);
    ...
    private void btn_pesq_discActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pesq_discActionPerformed
        ...
        TurmaDAO bd = new TurmaDAO((com.mysql.jdbc.Connection) con);
        List<Turma> lista = new ArrayList<>();
        lista = bd.Pesquisar_Cod_Turma(cod); 
        DefaultTableModel tbm = (DefaultTableModel) jTable.getModel();
    ...
    private void btn_pesq_nomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pesq_nomeActionPerformed
        String nome = nome_turma.getText();
        
        Connection con = Conexao.AbrirConexao();
        TurmaDAO bd = new TurmaDAO((com.mysql.jdbc.Connection) con);
        List<Turma> lista = new ArrayList<>();
        lista = bd.Pesquisar_Nome_Turma(nome); 
        DefaultTableModel tbm = (DefaultTableModel) jTable.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultar_turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField nome_turma;
