 ...
 * @author geova
 */
public class alterar_turma extends javax.swing.JFrame {

    /**
     * Creates new form TelaAdmin
     */
    public alterar_turma() {
        initComponents();
    }
    ...
    private void InserirDados(int id){
        ...
        lista = sql.Pegar_Turma(id);
        
        for (Turma a : lista) {
            id_tur.setText("" + a.getId());
            serie_tur.setText("" + a.getSerie());
        }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Digite o código da turma:");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(290, 170, 230, 30);

        serie_tur.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jPanel1.add(serie_tur);
        serie_tur.setBounds(290, 400, 230, 40);
        ...
        id_turma.setBounds(290, 210, 130, 40);
        ...
        jLabel12.setText("Série/turma:");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(290, 360, 230, 30);

        id_tur.setEditable(false);
        id_tur.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jPanel1.add(id_tur);
        id_tur.setBounds(290, 310, 230, 40);
    ...
    String codigo = id_tur.getText();
    String serie = serie_tur.getText();
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(alterar_turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField id_tur;
    ...
    private javax.swing.JTextField serie_tur;
